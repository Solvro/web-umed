  ...
  "cursor-pointer inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all duration-300 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        ...
        ghost:
          "hover:bg-secondary/90 hover:text-primary-foreground dark:hover:bg-secondary/90",
      ...
      size: {
        ...
        responsive:
          "h-9 px-4 py-2 md:h-11 md:rounded-md md:px-6 md:text-xl lg:h-15 lg:rounded-lg lg:px-7 lg:text-3xl",
        icon: "size-9",
      },
    },
    defaultVariants: {
